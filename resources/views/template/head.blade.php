    ...
    <link href="{{ asset('href/css/price-range.css') }}" rel="stylesheet">
    <link href="{{ asset('href/css/animate.css') }}" rel="stylesheet">
	<link href="{{ asset('href/css/main.css') }}" rel="stylesheet">
	<link href="{{ asset('href/css/responsive.css') }}" rel="stylesheet">
    <!--[if lt IE 9]>
    <script src="js/html5shiv.js"></script>
    <script src="js/respond.min.js"></script>
    <![endif]-->       
    <link rel="shortcut icon" href="{{ asset('href/images/ico/favicon.ico') }}">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ asset('href/images/ico/apple-touch-icon-144-precomposed.png') }}">
